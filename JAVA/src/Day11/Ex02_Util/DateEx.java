...
//			yyyy : 년도, 	MM : 월, 	dd ; 일
//			hh : 시, 			mm : 분, 	ss : 초
		String dateFormat = "yyyy년 MM월dd일hh시mm분ss초";
		...
		Date date1 = new SimpleDateFormat("yyyy/MM/dd").parse(day1);		//<--parse() 매개변수의 값을 형식토대로 삼아 양식의 일치 확인 
		Date date2 = new SimpleDateFormat("yyyy/MM/dd").parse(day2);
		
//		Date.getTime()
//		:  1970년 1월 1일 0시 0분0초부터 Date에 지정된 날짜/시간까지의 ms(밀리초) 누적값
...
//		-->날짜의 년/월/일 추출하는 기능은 Calendar 클래스에서 주로 사용
		...
		long day5TimeValue = dayTime*5;		//5일 
