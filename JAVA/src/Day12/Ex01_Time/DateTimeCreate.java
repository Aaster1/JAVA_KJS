...
//		LocalDate		:	날짜를 다루는 클래스
		...
		LocalDate nowDate = LocalDate.now();		//<--static 현재 날짜 정보를 클래스에 입히는 메소드 now()
		System.out.println("현재 날짜 : "+nowDate);
		
		LocalDate endDate = LocalDate.of(2024, 1,24);		//<-of()메소드의 역할은?? 날짜 정보를 지정하여 객체 생성
...
//		LocalDateTime	:	날짜/시간을 다루는 클래스
		...
		System.out.println("현재 시간 : "+endDateTime);
...
//		LocalDate.isLeapYear()	:	윤년이몀ㄴ true, 아니면 false 를 반환하는 메소드
