...
//		나노초 : 106^9초		(0.000000001초)
		...
		System.out.println("어레이리스트 10000칸 배열 중간 생성 시작");
...
//		ArrayList에 데이터 삽입
		...
		System.out.println("링크드리스트 10000칸 배열 중간 생성 시작");
		startTime = System.nanoTime();
//		ArrayList에 데이터 삽입
		for (int i = 0; i < 100000; i++) {
		...
		if(arrayListTime > linkedListTime) System.out.println("LinkedList가 중간 삽입이 더 빠르다");
		else System.out.println("ArrayList가 중간 삽입이 더 빠르다");
		System.out.println("---------------------------");
	}
